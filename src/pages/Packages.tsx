import { Check, MapPin, Calendar, Users, Sparkles, Wand2, Stars, X } from 'lucide-react';
...
export default function Packages() {
  ...
  const [addedPackages, setAddedPackages] = useState<number[]>(() => {
    ...
    return saved ? JSON.parse(saved).map((pkg: any) => pkg.id) : [];
  });
  ...
  const packages: Package[] = [
    {
      ...
      includes: ['Round-trip flights', '6 nights in 5-star resort', 'All meals included', 'Water sports activities', 'Spa treatment'],
      type: 'Luxury',
    },
    {
      id: 2,
      ...
      includes: ['International flights', '13 nights in 4-star hotels', 'Daily breakfast', 'Guided city tours', 'Museum passes'],
      type: 'Culture',
    },
    {
      id: 3,
      ...
      includes: ['Round-trip flights', '9 nights accommodation', 'JR Pass included', 'Traditional tea ceremony', 'Sushi making class'],
      type: 'Culture',
    },
    {
      id: 4,
      ...
      includes: ['International flights', 'Ferry transfers', '9 nights in hotels', 'Sunset cruise', 'Archaeological tours'],
      type: 'Beach & Culture',
    },
    {
      id: 5,
      ...
      includes: ['Round-trip flights', '4 nights in 5-star hotel', 'Desert safari', 'Burj Khalifa tickets', 'Dubai Mall tour'],
      type: 'Luxury',
    },
    {
      id: 6,
      ...
      includes: ['Round-trip flights', '7 nights accommodation', 'Daily yoga classes', 'Spa treatments', 'Healthy meals'],
      type: 'Wellness',
    },
  ];
  ...
  const handleAddToJourneys = (pkgId: number) => {
    ...
    localStorage.setItem('savedPackages', JSON.stringify(packages.filter(pkg => updatedPackages.includes(pkg.id))));
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="relative h-screen overflow-hidden">
        ...
        <div className="absolute inset-0 w-full h-full pointer-events-none">
          <iframe
            className="absolute top-1/2 left-1/2 w-[200vw] h-[200vh] -translate-x-1/2 -translate-y-1/2 scale-150"
        ...
        <div className="absolute inset-0 flex flex-col justify-center items-center text-center px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-gray-200 max-w-3xl mx-auto mb-8">
              Explore our curated travel packages with flights, hotels, and experiences all included. 
              Book now and let us handle the details!
            </p>
            <Button 
              size="lg" 
      ...
      {/* Packages Content */}
      <div id="packages-grid" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <motion.div
          ...
          className="mb-12"
        >
          <Card className="relative overflow-hidden bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-600 border-none shadow-2xl hover:shadow-3xl transition-all duration-500 group">
            ...
            <div className="absolute inset-0 opacity-20">
              ...
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-white rounded-full blur-3xl animate-pulse" style={{ animationDelay: '0.5s' }} />
            </div>
            ...
            <CardContent className="relative p-10 md:p-12 text-center">
              ...
              >
                <div className="relative">
                  ...
                  <Stars className="absolute -top-2 -right-2 size-6 text-yellow-300 animate-pulse" />
                  <Wand2 className="absolute -bottom-1 -left-1 size-6 text-white animate-bounce" style={{ animationDelay: '0.3s' }} />
                </div>
              </motion.div>
              ...
              <p className="mb-8 text-white/80 max-w-2xl mx-auto">
                Tell us your dreams, preferences, and budget. Our intelligent AI will craft a personalized itinerary 
                tailored just for you - from hidden gems to iconic destinations. Your adventure awaits! 🌍✨
              </p>

              {/* Features */}
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8 max-w-3xl mx-auto">
                <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 border border-white/20">
                  <Wand2 className="size-6 text-white mx-auto mb-2" />
                  <p className="text-white text-sm">AI-Powered Recommendations</p>
                </div>
                <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 border border-white/20">
                  <Stars className="size-6 text-yellow-300 mx-auto mb-2" />
                  <p className="text-white text-sm">Personalized Itineraries</p>
                </div>
                <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 border border-white/20">
                  <Sparkles className="size-6 text-white mx-auto mb-2" />
                  <p className="text-white text-sm">Instant Planning</p>
                </div>
              </div>
              ...
              <Button 
                size="lg" 
                className="bg-white text-purple-600 hover:bg-gray-100 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105 group-hover:scale-110"
                onClick={() => navigate('/ai-planner')}
              >
                <Sparkles className="size-5 mr-2" />
                Start AI Trip Planner
                <Wand2 className="size-5 ml-2" />
              </Button>
        ...
        <div className="flex gap-3 mb-8 flex-wrap justify-center">
          <Badge variant="outline" className="cursor-pointer hover:bg-gray-100 px-4 py-2">All Packages</Badge>
          <Badge variant="outline" className="cursor-pointer hover:bg-gray-100 px-4 py-2">Luxury</Badge>
          <Badge variant="outline" className="cursor-pointer hover:bg-gray-100 px-4 py-2">Culture</Badge>
          <Badge variant="outline" className="cursor-pointer hover:bg-gray-100 px-4 py-2">Beach & Relaxation</Badge>
          <Badge variant="outline" className="cursor-pointer hover:bg-gray-100 px-4 py-2">Adventure</Badge>
          <Badge variant="outline" className="cursor-pointer hover:bg-gray-100 px-4 py-2">Wellness</Badge>
        </div>
              ...
              <CardContent className="p-6">
                ...
                <div className="space-y-2 mb-6">
                  ...
                  {pkg.includes.length > 4 && (
                    <p className="text-sm text-gray-500 italic">+ {pkg.includes.length - 4} more</p>
                  )}
                </div>
                ...
                <div className="border-t pt-4">
                  ...
                  <div className="flex gap-2">
                    <Button className="flex-1" onClick={() => handleBookNow(pkg)}>
                      Book Now
                    </Button>
                    <Button 
                      variant="outline" 
                    ...
                    >
                      {addedPackages.includes(pkg.id) ? 'Added to Journeys' : 'Add to Journeys'}
                    </Button>
                  </div>
                </div>
              </CardContent>
      ...
      <Dialog open={bookingDialogOpen} onOpenChange={handleCloseDialog}>
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription>
              {bookingStep === 'details' && 'Please provide your travel details'}
              {bookingStep === 'payment' && 'Enter your payment information'}
              {bookingStep === 'confirmation' && 'Review your booking before confirming'}
            </DialogDescription>
          </DialogHeader>
            ...
            <div className="bg-blue-50 rounded-lg p-4 mb-4">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">{selectedPackage.destination}</p>
                  <p className="text-sm text-gray-600">{selectedPackage.duration}</p>
                  <p className="text-sm text-blue-600">${selectedPackage.price} per person</p>
                </div>
              </div>
            </div>
          )}
            ...
            <div className="space-y-6">
              <div className="bg-green-50 border border-green-200 rounded-lg p-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between items-center text-xl">
                    ...
                    <span className="text-blue-600">${(selectedPackage?.price || 0) * numberOfTravelers}</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                <p className="text-sm text-blue-900">
                  ...
                  In a real system, you would receive a confirmation email with your booking details.
                </p>
              </div>
