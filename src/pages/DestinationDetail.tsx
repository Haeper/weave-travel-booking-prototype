...
export default function DestinationDetail() {
  ...
  const destinationsData: Record<string, DestinationData> = {
    ...
    kochi: {
      ...
      subtitle: 'A peaceful slice of Japan with cherry blossoms and mountain landscapes',
      videoId: '-M8svKQkYsQ',
      startTime: 0,
    ...
    <div className="min-h-screen bg-white overflow-x-hidden">
      ...
      <div className="fixed top-24 left-8 z-50">
        <Button
          ...
          variant="outline"
          size="sm"
          className="gap-2 bg-white/90 backdrop-blur-sm hover:bg-white shadow-lg"
        >
          ...
          <div className="absolute bottom-0 left-0 right-0 bg-black/60 backdrop-blur-md border-t border-white/10">
            <div className="max-w-7xl mx-auto px-8 py-4">
              <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
                <div>
                  <p className="text-white/70 text-xs mb-1">Best time to visit</p>
                  <p className="text-white">{destination.bestTime}</p>
                </div>
                <div>
                  <p className="text-white/70 text-xs mb-1">Capital</p>
                  <p className="text-white">{destination.capital}</p>
                </div>
                <div>
                  <p className="text-white/70 text-xs mb-1">Population</p>
                  <p className="text-white">{destination.population}</p>
                </div>
                <div>
                  <p className="text-white/70 text-xs mb-1">Area</p>
                  <p className="text-white">{destination.area}</p>
                </div>
                <div>
                  <p className="text-white/70 text-xs mb-1">Official languages</p>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
            ...
            <div className="bg-gradient-to-br from-purple-50 to-pink-50 p-6 rounded-xl">
              ...
              <p className="text-gray-600 text-sm">Couples, families, and solo adventurers</p>
            </div>

            <div className="bg-gradient-to-br from-pink-50 to-orange-50 p-6 rounded-xl">
              <Plane className="size-8 text-pink-600 mb-3" />
              <h4 className="mb-2">Getting There</h4>
              <p className="text-gray-600 text-sm">International flights available from major hubs</p>
            </div>
          </div>

          {/* CTA Section */}
          <div className="mt-16 bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-12 text-center">
            <h3 className="text-white mb-4">Ready to Start Your Journey?</h3>
            <p className="text-white/90 mb-8 text-lg">
              Explore our curated packages and start planning your adventure to {destination.name}
            </p>
